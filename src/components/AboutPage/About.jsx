...
const About = () => {
    return (
        <div className="flex flex-col h-auto items-center justify-center">
            <div className=" flex flex-col gap-5 items-center p-5 lg:h-1/2 justify-center">
                <h1 className="text-3xl md:text-5xl font-bold border-b-2 border-smokey ">My Values</h1>
