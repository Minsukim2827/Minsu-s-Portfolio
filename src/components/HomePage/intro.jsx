    ...
    return (
        <div className="pt-8 flex flex-col md:flex-row h-auto md:h-screen justify-center items-center gap-4 md:gap-8 max-w-7xl mx-auto p-4">
            <div className="flex-1 flex flex-col justify-evenly gap-3">
                ...
                <p className="text-base md:text-lg font-bold">My name is Minsu! Explore my portfolio where I showcase my skills in web development, backend development, and much more! Creating new projects while learning better development fundamentals every day.</p>
